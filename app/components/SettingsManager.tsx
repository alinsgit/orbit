...
import { Settings, Loader2, Sun, Moon, Monitor, Palette, Trash2, Eraser, Info, ExternalLink, Heart, ArrowUpCircle, Sparkles, RotateCcw, FolderOpen, RefreshCw, CheckCircle, Terminal, Network, Zap, Server, Plus, X, Check, FileKey, Lock, Wifi } from 'lucide-react';
        ...
        <section className="bg-surface-raised border border-edge-subtle rounded-xl overflow-hidden">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <GithubIcon size={18} className="text-content-secondary" />
                <div>
            ...
            <div className="text-center text-xs text-content-muted pt-2 border-t border-edge-subtle">
              ...
              <p className="mt-1">Copyright (c) 2026-present alins</p>
            </div>
          </div>
        </section>
      </div>
