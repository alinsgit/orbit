...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
        ...
        commands::cache::install_memcached,
        commands::cache::uninstall_memcached,
        commands::cache::update_redis_config,
        commands::cache::update_memcached_config,
        commands::cache::get_redis_exe_path,
        commands::cache::get_memcached_exe_path,
        // Composer
    ...
    .unwrap_or_else(|e| {
        ...
        eprintln!("Error: Failed to start application: {}", e);
        std::process::exit(1);
    });
}
