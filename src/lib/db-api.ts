...
export async function getServerInfo(): Promise<ServerInfo> {
  ...
  console.log('Server info results:', { versionResult, uptimeResult, connectionsResult });
...
export async function listDatabases(): Promise<DatabaseInfo[]> {
  ...
  console.log('SHOW DATABASES result:', result);

  const databases: DatabaseInfo[] = result.map(row => ({
