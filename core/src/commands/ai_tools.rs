...
/// Check latest available version of Gemini CLI from npm registry
#[command]
pub fn check_gemini_update(app: AppHandle) -> Result<Option<String>, String> {
    GeminiCliManager::check_latest_version(&app)
}
